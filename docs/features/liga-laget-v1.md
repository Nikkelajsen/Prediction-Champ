...
> **Rettet efter levering (onboarding v1, juli 2026):** "Ny konkurrence"-knappen lå inde i "Øvrige konkurrencer"-blokken, som kun renderes, når man HAR liga-løse konkurrencer. En bruger uden nogen havde dermed slet ingen vej til at oprette en konkurrence fra fanen — præcis den bruger, der havde mest brug for den. Knappen ligger nu fast i "Dine ligaer"-rækken øverst. Join-feltet bruger nu `joinByInviteCode` (`data.js`) frem for sin egen kopi, jf. [`onboarding-v1.md`](./onboarding-v1.md) §8.
