...
24. Rekorder-linjerne navngiver kilden i selve sætningen ("Championships rundechampionship", "globale rating"). Ordet "konkurrence" må ikke stå i ental om Rekorder, da det inviterer til at læse tallet som én bestemt konkurrence.
...
28. Bruger vinder en **afsluttet** sæson → "🏆 Sæsonens Champion — *sæsonnavn*" står **først** blandt titel-badges. To brugere ægte lige hele stigen ned → begge får titlen.
...
48. Tallene navngiver stadig deres eget omfang i sætningen ("i Championships rundechampionship", "globale rating", "af N spillere") — det er dét, der bærer førstelæsningen, når brødteksten er væk. Testcase 24 gælder uændret.
...
|---|---|---|
| Titler | **Globalt** — Championships måneds- og rundechampionship, alle brugere automatisk med | `monthly_standings` (`scope='ALL'`), `round_standings` |
...
**Reglen fremover:** et tal på karriereskærmen skal navngive sit eget omfang i den sætning, det står i. Sektionens overskrift bærer kontrasten; `InfoDot` uddyber. ~~En synlig scope-linje bærer kontrasten sammen med overskriften; `InfoDot` uddyber, men bærer aldrig alene en oplysning, der er nødvendig for at læse et tal rigtigt.~~ **[Rettet 30. juli 2026, tredje runde — se afsnit 13]:** den synlige scope-linje blev afvist af brugeren og er fjernet. `InfoDot` bærer nu forklaringen alene, og det er tallenes egen formulering ("i Championships rundechampionship", "globale rating"), der gør førstelæsningen rigtig.
