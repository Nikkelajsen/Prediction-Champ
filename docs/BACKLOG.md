...
- De fem football-data-jobs kørte 24–26 gange i døgnet i A11-opslaget (2. august 2026), altså cirka hver time — mens `CRON.md`, `DOCUMENTATION.md` §8 og heartbeat'ens 26-timers grænse alle regner med hver 12. time; enten er cron-job.org sat anderledes end registeret siger, eller også skal registeret rettes, og i begge tilfælde er kaldbudgettet på 10 kald/døgn i §8 reelt ~120
