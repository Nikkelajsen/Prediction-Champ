...
|---|---|---|---|
| B2 | **Turnering #2: bekræft Scotland Premiership i drift** | **Koden er leveret 31. juli 2026**, SQL-scriptet er kørt, og cron-jobbet er oprettet (job #5 i [`CRON.md`](./CRON.md)). To af de fire verifikationspunkter blev lukket i august 2026 ved at gøre dem til kode (dubletkontrollen ved hver sync, fasenavnene efterprøvet mod `STAGE_LABELS`). **To mere er lukket ved aflæsning 2. august 2026** i Admin → Drift: kørslen henter **198 af 198** kampe med tom `unmatched`, `undrawn: 0` og ingen nye hold — ingen stille trunkering (acceptkriterie 1), og 198 er præcis grundspillets 12 hold × 33 runder ÷ 2, mens `2nd Phase` endnu ikke er skemalagt. `ambiguousTeams` melder ét par, **Dundee / Dundee United** — en ægte navnelighed og ikke en dublet: begge klubber står som hver sin række, ellers ville kun det ene navn optræde i listen. **Tilbage står testcases 2–6** i [`features/turnering-2.md`](./features/turnering-2.md) §6, som kun kan køres i brugerfladen mod produktionsdata. | Lille (drift) |
