...
| # | Hvad | Hvorfor her |
|---|---|---|
| `B12` | Kør §5F-forespørgslen i [`features/analytics-v1.md`](./features/analytics-v1.md) | **Forsøgt 5. august 2026: forespørgslen kunne ikke køre** (`42803` — vinduet partitionerede på et udtryk uden for `group by`). Den er omskrevet og efterprøvet mod PostgreSQL 16.13 med plantede data, men **svaret mangler stadig**. Svarer samtidig på `I15`s åbne spørgsmål, om Ugens kupon-kortet overhovedet bruges — to rækker for ét opslag. |
