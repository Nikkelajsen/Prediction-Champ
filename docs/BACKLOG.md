...
- Sælgesætningen står nu tre steder (`index.html`, `AuthShell`, `site/index.html`) — en `<meta>` kan ikke importere fra `src/`, så dubletten er bevidst, men den kan drive.
