...
**Eksplicit næste handling:** ~~eksportér kerneskemaet til `sql/schema.sql`~~ **Gjort (juli 2026** — automatiseret ugentligt via `.github/workflows/schema-export.yml`, guide i [`sql/README.md`](../sql/README.md)**)**. Næste: afgør F2 (én pointkilde) og K1 (profil-synlighed) i [`features/karriereprofil-v1.md`](./features/karriereprofil-v1.md), og A2 ved turnering #2 — derefter kan trin 4 og [`features/turnering-2.md`](./features/turnering-2.md) bygges.
