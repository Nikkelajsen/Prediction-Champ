...
**Senest opdateret: 24. juli 2026** (skema-eksport automatiseret: `sql/schema.sql` + ugentlig workflow) · *Levende dokument — opdateres, hver gang en feature leveres eller en beslutning træffes. Filosofien bag prioriteringen: [`PRODUCT_BOOK.md`](./PRODUCT_BOOK.md).*
...
**Eksplicit næste handling:** ~~eksportér kerneskemaet til `sql/schema.sql`~~ **Gjort (juli 2026** — automatiseret ugentligt via `.github/workflows/schema-export.yml`, guide i [`sql/README.md`](../sql/README.md)**)**. F2, K1 og A2 er afgjort (se beslutningsloggen) — **næste: byg karriereprofilen** ([`features/karriereprofil-v1.md`](./features/karriereprofil-v1.md)); derefter turnering #2 ([`features/turnering-2.md`](./features/turnering-2.md), afklar Sportmonks-abonnement).
