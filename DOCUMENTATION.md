...
Kampene er grupperet pr. kampdag med en dag-overskrift ("LØR 25. JUL"), så rækken kun viser klokkeslættet. Hver kamp er én til to linjer: klokkeslæt + hold, og (kun hvis relevant) en mærke-linje med LIVE/Slut/stage/"Alles gæt". Kampe i gang viser nuværende stilling + LIVE-mærke (uden point — de afgøres først ved slutfløjt); færdigspillede viser eget gæt dæmpet, facit i farvet ramme (guldkant ved præcist hit) og en pointpille. Er hele runden spillet, udelades "Slut" pr. række (hovedet siger det). Kan der ikke længere rettes, vises eget gæt som tal i stedet for to deaktiverede felter.
