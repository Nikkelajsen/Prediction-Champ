...
Tip (forudsigelser) — to faste dropdowns: filtrér på liga (matchens egen liga via `season_id`) og/eller konkurrence ("Alle konkurrencer" eller én); begge vises altid. Kampe deduplikeres pr. runde. Starter på den runde der indeholder i dag (eller nærmeste kommende). Grønt ✓ efter et gemt gæt. Nedtælling ("Låser om X t Y min") for kampe der låser inden for 24 timer. Kampe i gang viser nuværende stilling + LIVE-mærke (uden point — de afgøres først ved slutfløjt), færdigspillede viser resultat + point og et "Slut"-mærke. "Alles gæt" foldes ud under en låst kamp og viser alle deltageres gæt + point.
