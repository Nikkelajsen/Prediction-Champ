...
> indlæser filen.
>
> 🔴 **`#58` (`G98`) er lagt til samme dag og skal køres i staging og
> produktion**; den er den tredje, dumpet vil mangle, indtil eksporten kører
> igen. Også den er efterprøvet fra begge sider — de fjorten skema-indlæsende
