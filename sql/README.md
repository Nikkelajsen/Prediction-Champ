...
> indlæser filen.
>
> 🔴 **`#59` og `#60` (`A43`) er lagt til 12. august 2026 og er de nyeste, dumpet mangler.** De er en TODELT migrering med et deploy imellem — `#59` er additiv og kan køres når som helst, `#60` først når den nye klient er ude. Runbog: [`docs/UDRULNING-A43.md`](../docs/UDRULNING-A43.md). Efterprøvet fra begge sider som de foregående.
>
