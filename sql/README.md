...
> 🔶 **ØJEBLIKSBILLEDET HALTER TRE MIGRERINGER (14. august 2026): `#61`, `#62`
> og `#63` er ikke med.** Det er ufarligt for CI — hver af de tre har en test,
> der ANVENDER sin egen migrering oven på dumpet, altså måler fra den side,
> eksporten lander på. Men `schema.sql` er indtil eksporten kører **ikke** en
> gyldig reference for `competition_match_points`, `group_counts` eller
> `competition_participant_history`.
>
> ✅ **Sidst friske øjebliksbillede: eksporten er kørt 12. august 2026, efter
